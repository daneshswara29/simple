...
# domain random
CDN="https://raw.githubusercontent.com/daneshswara29/simple/main/ssh"
cd /root
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/daneshswara29/simple/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#install backup
echo -e "\e[33m-----------------------------------\033[0m"
echo -e "$BGreen      Install BACKUP               $NC"
echo -e "\e[33m-----------------------------------\033[0m"
sleep 0.5
clear
clear
wget https://raw.githubusercontent.com/daneshswara29/simple/main/backup/set-br.sh &&  chmod +x set-br.sh && ./set-br.sh
clear
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
...
sleep 0.5
clear
wget https://raw.githubusercontent.com/daneshswara29/simple/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/daneshswara29/simple/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
#Instal menu
echo -e "\e[33m-----------------------------------\033[0m"
echo -e "$BGreen          Install menu              $NC"
echo -e "\e[33m-----------------------------------\033[0m"
sleep 0.5
clear
wget --no-check-certificate https://raw.githubusercontent.com/daneshswara29/simple/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
#Instal limit
echo -e "\e[33m-----------------------------------\033[0m"
echo -e "$BGreen          Install limit              $NC"
echo -e "\e[33m-----------------------------------\033[0m"
sleep 0.5
clear
wget --no-check-certificate https://raw.githubusercontent.com/daneshswara29/hm/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/daneshswara29/simple/main/menu/versi  )
...
echo "---------------------------t.me/D_swara-----------------------------" | tee -a log-install.txt
echo "==================================================================" | tee -a log-install.txt
echo -e ""
echo ""
echo "" | tee -a log-install.txt
