...
cpu_usage+=" %"
ISP=$(curl -s ipinfo.io/org?token=7a814b6263b02c | cut -d " " -f 2-10 )
CITY=$(curl -s ipinfo.io/city?token=7a814b6263b02c )
WKT=$(curl -s ipinfo.io/timezone?token=7a814b6263b02c )
DAY=$(date +%A)
DATE=$(date +%m/%d/%Y)
...
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo -e   ""
echo -e "\e[1;36m --------------------t.me/D_swara-------------------\e[0m"
echo -e   ""
